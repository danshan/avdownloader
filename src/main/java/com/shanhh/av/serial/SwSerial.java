 ...
 */
public class SwSerial implements Serial {

    private static final String COVER_URL_TEMPLATE = "http://pics.dmm.co.jp/digital/video/1sw00{0}/1sw00{1}pl.jpg";
    private static final String SERIAL_ID_TEMPLATE = "SW-{0,number,000}";

    private static Serial instance = new SwSerial();
    private SwSerial() {}
